...
import { fileUploadEvent } from '../../common/Commons';

export default function ProfileContacts(params: { id: number }) {
    const countries = commons.getCountryNamesJSON();
    const appContext = useContext(AppContext);
    
    const [companyID, setCompanyID] = useState(0);
    const [companyDataSet, setCompanyDataSet] = useState<ICompany>({} as ICompany);
    ...
    const companyInfoUploadEvent = (data: fileUploadEvent) =>  {
        setPercent(0);
        if(data.status == 0) {
                            ...
                            <div>
                                <div className="row">
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-xl-2">
                                                <Button type="button" color="vk" size="tiny" 
                                                    onClick={ () => commons.uploadFile(  "accounts/backend/uploadfile", "documentFileUploadFileInput", 
                                                    Public_Enums_Constants.SERVER_FILE_DESTINATION.AWS_Bucket_Public, setPercent, 
                                                    companyInfoUploadEvent  )}>
                                                        Upload
                                                </Button> 
                                            </div>
                                        </div> 
