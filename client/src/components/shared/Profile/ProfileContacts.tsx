...
export default function ProfileContacts() {
    ...
    const editContactDataForm = (value: number) => () => {
    ...
    return (  
        <div>
                ...
                <div className="col-xl-12">
                    <div className="card">
                            ...
                            <div className="card-block table-border-style">
                                ...
                                {userContacts && userContacts.map(( dat: IContacts) =>                                    
                                    <span>
                                        <div className="row">
            ...
            <Modal size="sm" show={confirmationModelShow} onHide={() => setConfirmationModelShow(false)}>
